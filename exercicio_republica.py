...
1) Qual a descricao dessa conta? (é a string, o primeiro elemento da lista conta)
'''
...
Dica: e o tamanho da lista que esta dentro de conta[2]. Tente usar 
uma expressão em python apropriada para gerar esse valor
'''
numero_de_participantes = 'x for x in conta[2]' # em vez de escrever os valores, tente acessar eles da lista acima
...
'''
valor_por_pessoa = 'coloque o valor aqui' # em vez de escrever os valores, tente acessar eles da lista acima
...
assert verifica(descricao_da_conta, '96e3cebcd795276f4049bf6fafd285c3a1de35fdd4ed6fa1f678528a'), "descricao_da_conta incorreta"
assert verifica(valor_da_conta, 'd19b32c10762f0526854355f3a947f8b332be76043aa0476a7dc7a28'), "valor_da_conta incorreta"
assert verifica(numero_de_participantes, '1f1828e52d7ae038235abf190e8f61ed490c0e4182296ad821cdc219'), "numero_de_participantes incorreta"
assert verifica(valor_por_pessoa, '1a601a5f3947130567d5b6cbea7b1136ca4c03c44e961a1ac2420167'), "valor_por_pessoa incorreta"
...
ana_dividiu = 'coloque o valor aqui' #em vez de usar True ou False, tente escrever essa expressão usando o operador IN como acima

'''
2) O Daniel dividiu essa conta? (True ou False)
'''
daniel_dividiu = 'coloque o valor aqui' #em vez de usar True ou False, tente escrever essa expressão usando o operador IN como acima
...
assert verifica(ana_dividiu, 'b45899583510159617e22fca2b6f561a09289be12ccb30f6df8d4a11'), "ana_dividiu incorreta"
assert verifica(daniel_dividiu, '623d4fc7bd6d8878dd37a9fd4a591ddfa41a2487f53809e84fd9e7c4'), "daniel_dividiu incorreta"
...
como vimos no aquecimento. Entao `contas` e uma LISTA DE LISTAS:
...
divida_da_ana = 'coloque o valor aqui'

'''
2) Quanto a Carla deve no total?
'''
divida_da_carla = 'coloque o valor aqui'

'''
3) Quanto a Eva deve no total?
'''
divida_da_eva = 'coloque o valor aqui'
...
assert verifica(divida_da_ana, '18daa7fac9ca8f74f8f7be8b99d6bdea18579e7ea9dfb7556056fda2'), "divida_da_ana errada"
assert verifica(divida_da_carla, 'bfaa3e63a35f75bed4887fd6662cbc2335fb49d7141341c97e1ceac3'), "divida_da_carla errada"
assert verifica(divida_da_eva, '81260578ba6b60dd121778b4e26ad4c8d2eb1d3ce2c8da38567dbb92'), "divida_da_eva errada"
