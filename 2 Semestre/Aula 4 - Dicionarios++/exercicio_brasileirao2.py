...
'''
times_do_jogo_102094 = 'coloque o valor aqui'
data_do_jogo_102132 = 'coloque o valor aqui'
quantos_jogos_no_ano = 'coloque o valor aqui'
quantas_datas_de_jogo = 'coloque o valor aqui'
jogos_de_2018_04_14 = 'coloque o valor aqui'
...
'''
o_que_e_jogos_id = 'coloque o valor aqui'   # 'a', 'b', 'c' ou 'd'
...
'''
o_que_e_jogos_data = 'coloque o valor aqui'   # 'a', 'b', 'c' ou 'd'
...
'''
placar_e_string = 'coloque o valor aqui'   # 'a', 'b', 'c' ou 'd'
...
par_de_ids_a_mao = 'coloque o valor aqui'
...
par_de_nomes_a_mao = 'coloque o valor aqui'
...
contagem_estadios_a_mao = 'coloque o valor aqui'
...
Como criar a contagem inicial (um dicionario vazio)?
    ...
    d) contagem = [{}]
'''
init_contagem = 'coloque o valor aqui'   # 'a', 'b', 'c' ou 'd'
...
'''
percorre_jogos = 'coloque o valor aqui'   # 'a', 'b', 'c' ou 'd'
...
'''
pega_estadio = 'coloque o valor aqui'   # 'a', 'b', 'c' ou 'd'
...
'''
por_que_checar = 'coloque o valor aqui'   # 'a', 'b', 'c' ou 'd'
...
'''
como_checar = 'coloque o valor aqui'   # 'a', 'b', 'c' ou 'd'
...
'''
estadio_novo = 'coloque o valor aqui'   # 'a', 'b', 'c' ou 'd'
...
'''
incremento_estadios = 'coloque o valor aqui'   # 'a', 'b', 'c' ou 'd'
...
ids_dos_jogos_do_25_a_mao = 'coloque o valor aqui'
...
'''
datas_do_25_a_mao = 'coloque o valor aqui'
...
gols_por_time_a_mao = 'coloque o valor aqui'
time_mais_gols_a_mao = 'coloque o valor aqui'
